...
class PickerDialogView: DialogBaseView {
	...
	@IBOutLet weak var obHeightConstraint: NSLayoutConstraint!
...
extension PickerDialogView: UIPickerViewDataSource, UIPickerViewDelegate {
	...
	func pickerView(_ pickerView: UIPickerView, numberOfRowsInCompment component: Int) -> Int {
		return pickerTypes[componeng].count!
	}
	...
	//选中指定行列
	func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent componeng: Int) {
		//所在第0列的行数
