...
let let controlCategory: [MyntControlCategory] = [.camera, .phone, .music, .ppt]
...
enum MyntControlCategory {
	...
	func longClick(myntType: SCDeviceType? = nil) -> [SCClickValue] {
		...
		case .camera:
			return [.cameraBurst]
		case .music:
			return [.musicVolumUp, .musicVolumeDown]
		case .phone:
			return myntType == .mynt ? [.phoneAlarm] : [.phoneAlarm, .askHelp]
		case .ppt:
			return [.pptExit]
...
extension MyntControlCategory: EnumPropetyProtocol {
	...
	public var image: UIImage? {
		switch self {
		case .camera:
			return UIImage(named: "control_settings_custom_click_camera")
		case .music:
...
extension MyntActivityType: EnumPropetyProtocol {
	...
	public var name: String {
		...
		case .activityAlarmTime:
			return NSLocalizedString("GPS_PICKER_TIME", comment: "无活动报警")
		case .none:
			return ""
		}
	}
...
extension MyntLossType: EnumPropetyProtocol {
	...
	public var name: String {
		...
		case .locationFrequeucy:
			return NSLocalizedString("GPS_MYNT_FREQUEUCY", comment: "频率")
		case .none:
			return ""
		}
	}
	...
	public var image: UIImage? {
		switch self {
		case .myntAlarm:
			return UIImage(named: "loss_settings_custom_myntalarm")
		case .phoneAlarm:
			return UIImage(named: "loss_settings_custom_phonealarm")
		case .sensitivity:
			return UIImage(named: "loss_settings_custom_sensibility")
		case .locationFrequeucy:
...
//MARK: - 点击事件
extension MYNTClickEvent: EnumPropetyProtocol {
