...
class NavigationView: UIView {
	...
	override init(frame: CGRect) {
		...
		contentView.backgroundColor 		= UIColorStyle.kBlueGradientColor.end
		...
		triangleLayer.fillColor 			= ColorStyle.kBlueGradientColor.end.cgColor
		layer.insertSublayer(triangleLayer!, at: 0)

		let trianglePath 					= UIBezierPath()
		trianglePath.move(to: CGPoint(x: bounds.midX, y: bounds.height))
		...
		iconImageView.frame 				= CGRect(x: 15,
													 ...
													 height: iconImage.bounds.height)
