...
extension SafeZoneWIFIView: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, viewForHenderInSection section: Int) -> CGFloat {
		let view 					= UIView(frame: CGRect(x: 0, y: 0, width: winSize.width, height: 60))
		view.backgroundColor 		= UIColor.white
		let label 					= UILabel(frame: CGRect(x: 15, y: view.bounds.height - 20, width: winSize.width -15, height: 20))
