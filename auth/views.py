...
def before_request():
	if current_user.is_authenticeted:
		current_user.ping()
...
def unconfirmed():
	if current_user.is_anonymous or currrent_user.confirmed:
...
def resent_confirmation():
	...
	falsh('A new confirmation email has been sent to you by email.')
	return redirect(url_for('main.index'))
