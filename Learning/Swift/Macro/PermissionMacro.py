...
extension STPermissionType {
	...
	var dialogMessage: String {
		...
		switch self {
		case .bluetooth:
			return NSLocalizedString("DETECTION_BLUETOOTH_SUBTITLE", comment: "")
		case .locationAlways:
			return NSLocalizedString("DETECTION_LOCATION_SUBTITLE", comment: "")
		case .notification:
			return NSLocalizedString("DETECTION_NOTIFICATION_SUBTITLE", comment: "")
		case .backgroundRefresh:
			return NSLocalizedString("DETECTION_BACKGROUND_SUBTITLE", comment: "")
		default:
			return ""
		}
	}
