...
func jf_setupFooterRefresh(_ target: AnyObject, action: Selector) -> MJRefreshAutoNormalFooter {
	...
	footerRefresh.setTitle("上拉可加载更多壁纸", for: MJRefreshState.idle)
...
快速创建下拉加载最新控件
*／
fun if_setupHeaderRefresh(_ target: AnyObject, action: Selector) -> MJRefreshNormalHeader {
...
//控制器背景颜色
let BACKGROUND_COLOR(red:0.933, green:0.933, blue:0.933, alpha:1)
