...
extension JFNetworkTools {
	...
	*/
	func get(_ APIStringL String, parameters: [String : Any]?, finished: @escaping
		NetworkFinished) {

		UIApplication.shared.isNetworkActivityIndicatorVisible = true
		print("APIString = \(APIString)")
		Alamofire.request(APIString, method: .get, parameters: parameters, heads: nil).
	...
	*/
	func post(_ APIString: String, parameters: [String : Any]?, finished: @escaping
		NetworkFinished) {

		UIApplication.shared.isNetworkActivityIndicatorVisible = true
		print("APIString = \(APIString)")
		Alamofire.request(APIString, method: .post, parameters: parameters, headers: nil).
			responseJSON { (response) in
			self.handle(response; response, finished: finished)
		}
	}
