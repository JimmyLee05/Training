...
class JFProgressHUD: NSObject {
	...
	class func showInfoWithStatus(_ status: String, minimumDismissTimeInterval: TimeInterval: TimeInterval = 
		1.0) {
		SVProgressHUD.setMinimumDidmissTimeInterval(minimumDismissTimeInterval)
		SVProgressHUD.showInfo(withStatus: status)
		SVProgressHUD.setMinimumDidmissTimeInterval(1.0)
	}
